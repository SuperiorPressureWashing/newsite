...
const serviceData: Service[] = [
    ...
    },
    {
        ...
        shortDesc: "Oxidation is a chemical breakdown of a specific material. Rust is the oxidation of steel. Overtime vinyl, hardie board, and metal oxidize.",
        desc: `Oxidation is a chemical breakdown of a specific material. Rust is the oxidation of steel. Overtime vinyl, hardie board, and metal oxidize. Oxidation often times occurs to surfaces that have extreme exposure to U.V rays. Oxidation can also occur if certain solutions are misused to clean a house or building. 

        Oxidation leaves a chalky film over the surface. Most of the time you can rub your fingers on the surface, and if a chalky dust is on your fingers, that is oxidation. Oxidized surfaces that are pressure washed, leaves line marks on the surface. 
        
        Oxidation removal is necessary before painting. Oxidation will not come off with soft washing, or even pressure washing. It must be removed with solution specifically designed for it, agitation of the surface, proper dwell time, and rinsing. `
    },
